...
Begin VB.Form foodlab 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton Command1 
         ...
         Height          =   615
         Left            =   3480
         Picture         =   "foodlab.frx":2EEF2
         Style           =   1  'Graphical
         TabIndex        =   9
         ToolTipText     =   "Prints the current Data"
         Top             =   6600
         Width           =   855
      End
      ...
      Begin VB.CommandButton searchbtn 
         ...
         Height          =   495
         Left            =   10560
         Picture         =   "foodlab.frx":326F4
         Style           =   1  'Graphical
         TabIndex        =   7
         ToolTipText     =   "Find Item Name"
         Top             =   6600
         Width           =   615
      End
